...
module tb_aer_v1_top_128;
    ...
    initial begin
        ...
        if (transfer_count != 3) begin
            $display("AER_V1_TOP_TIMEOUT transfers=%0d", transfer_count);
            $fatal(1);
        end
        ...
        $display("AER_V1_TOP_128_PASS time_word=%h", captured[1]);
        $finish;
    end
